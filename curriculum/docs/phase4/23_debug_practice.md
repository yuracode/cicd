...
6. **隣の学生のリポジトリと「壊しっこ交換」** をする：お互いのリポジトリに1つずつ故意のバグを入れた PR を送り合い、相手のPRを時間制限内（15分）でデバッグ＆修正する。**他人のコードのデバッグ** は自分のコードより難しい、を体感する
